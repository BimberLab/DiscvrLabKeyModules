 ...
 * Date: 1/22/13
 */
public class BioTrustRCRole extends AbstractBioTrustRole
{
    public BioTrustRCRole()
    {
        super("NWBT Research Coordinator",
                "NWBioTrust research coordinators may view and edit specimen request forms. " +
                        "They are able to control specimen request workflow states as well as assign/request reviews and " +
                        "indicate review determinations.",
