 ...
 * Date: 1/18/13
 */
public class DocumentTypesTable extends FilteredTable<BioTrustQuerySchema>
{
    public DocumentTypesTable(TableInfo ti, BioTrustQuerySchema schema)
    {
        super(ti, schema);
        ...
        List<FieldKey> defaultColumns = new ArrayList<>(Arrays.asList(
                ...
                FieldKey.fromParts("AllowMultipleUpload"),
                FieldKey.fromParts("Expiration")
        ));
