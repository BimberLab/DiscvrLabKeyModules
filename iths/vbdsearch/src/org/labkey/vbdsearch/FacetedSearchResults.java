 ...
 * Date: 10/23/13
 */
public class FacetedSearchResults extends AbstractSearchResults
{
    /**
     * returns specimen and person totals grouped by specimen category and repository,
    ...
    public static ResultSet getResults(FacetedSearchForm form, UserSchema listSchema) throws SQLException
    {
        ...
        sqlFrag.append(LIST_NAME + ".repositoryShortName, ");
    ...
    {
        SQLFragment sqlFrag = new SQLFragment("SELECT ");
        sqlFrag.append("'total'").append(" AS repositoryShortName, ");
        sqlFrag.append(LIST_NAME + ".specimenCategory, ");
        sqlFrag.append("COUNT(DISTINCT " + LIST_NAME + ".personID) as personCount, ");
        sqlFrag.append("COUNT(*) as specimenCount ");
        sqlFrag.append("FROM " + LIST_NAME);
    ...
    /**
     * returns specimen and person totals grouped by repository,
     * filtered by the specified form
     */
    public static ResultSet getRepositoryTotals(FacetedSearchForm form, UserSchema listSchema) throws SQLException
    {
        SQLFragment sqlFrag = new SQLFragment("SELECT ");
        sqlFrag.append(LIST_NAME + ".repositoryShortName, ");
        sqlFrag.append("COUNT(DISTINCT " + LIST_NAME + ".personID) as personCount, ");
