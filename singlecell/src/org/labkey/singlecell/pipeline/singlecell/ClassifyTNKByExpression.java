    ...
    public static class Provider extends AbstractPipelineStepProvider<SingleCellStep>
    {
        public Provider()
        {
            super("ClassifyTNKByExpression", "Classify T/NK By Expression", "RDiscvr", "Classify T and NK By Expression and TCR clonotype, using best available evidence of ground-truth.", Arrays.asList(
                    SeuratToolParameter.create("collapseGOnlyToGD", "Collapse Gamma/Only", "If checked, cells labeled as gamma-chain-only will be collapsed to the Gamma/Delta category", "checkbox", null, false)
            ), null, null);
        }
