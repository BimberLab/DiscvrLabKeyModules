        ...
        return {
            ...
            items: [{
                ...
                tpl: [
                    ...
                    '</tpl>',
                    '<tpl if="dataId">',
                        '<td><a href="{[LABKEY.ActionURL.buildURL("sequenceanalysis", "qualiMapReport", values["container/path"], {dataIds: values.dataId, cacheResults: false})]}" target="_blank">View QualiMap Report</a></td>',
                    '</tpl>',
                    '<tpl if="!dataId">',
                        '<td><a href="{[LABKEY.ActionURL.buildURL("sequenceanalysis", "qualiMapReport", values["container/path"], {filenames: values.fileName, cacheResults: false})]}" target="_blank">View QualiMap Report</a></td>',
                    '</tpl>',
                    '</tr>',
                    '</tpl>',
                    '</table>'
