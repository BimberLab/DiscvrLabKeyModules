...
ALTER TABLE sequenceanalysis.alignment_summary_junction ADD created TIMESTAMP;
ALTER TABLE sequenceanalysis.alignment_summary_junction ADD modifiedby USERID;
ALTER TABLE sequenceanalysis.alignment_summary_junction ADD modified TIMESTAMP;
