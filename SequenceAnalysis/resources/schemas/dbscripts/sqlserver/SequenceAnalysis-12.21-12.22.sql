...
alter table sequenceanalysis.ref_nt_sequences alter column createdby integer;
alter table sequenceanalysis.ref_nt_sequences alter column modifiedby integer;
