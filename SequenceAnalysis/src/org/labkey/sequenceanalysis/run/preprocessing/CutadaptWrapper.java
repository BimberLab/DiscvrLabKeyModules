...
public class CutadaptWrapper extends AbstractCommandWrapper
{
    ...
    public static class Provider extends AbstractPipelineStepProvider<PreprocessingStep>
    {
        public Provider()
        {
            super("AdapterTrimming", "Adapter Trimming", "This provides the ability to trim adapters from the 5' and/or 3' end of the reads.  5' trimming will always be performed first, followed by a second round if 3' adapter trimming was selected.", Arrays.asList(
