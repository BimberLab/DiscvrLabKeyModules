...
public class Bowtie2Wrapper extends AbstractCommandWrapper
{
    ...
    public static class Bowtie2AlignmentStep extends AbstractCommandPipelineStep<Bowtie2Wrapper> implements AlignmentStep
    {
        public Bowtie2AlignmentStep(PipelineStepProvider provider, PipelineContext ctx)
        {
