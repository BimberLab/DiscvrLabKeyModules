...
public class AASnpByCodonAggregator extends NtSnpByPosAggregator
{
    ...
    public AASnpByCodonAggregator(SequencePipelineSettings settings, Logger log, AvgBaseQualityAggregator avgQualAggregator)
    {
    ...
    {
        _log.info("Saving AA SNP Results to DB");
        ...
        try (DbScope.Transaction transaction = ExperimentService.get().ensureTransaction())
        {
            ...
            _log.info("\tTotal AA Reference sequences encountered: " + summary.keySet().size());
    ...
    private class CacheKeyInfo
    {
        ...
        public CacheKeyInfo(AASnp snp)
        {
            ...
            //infer ID
            String[] tokens = _ntRefName.split("\\|");
            _ntRefId = Integer.parseInt(tokens[0]);
