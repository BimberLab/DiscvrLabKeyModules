...
//    }
    ...
    @Override
    public File combineVcfs(List<File> files, File outputGz, Logger log, boolean verifyHeadersIdentical) throws PipelineJobException
    {
        return SequenceUtil.combineVcfs(files, outputGz, log, verifyHeadersIdentical);
    }
}
