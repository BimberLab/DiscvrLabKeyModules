...
wget http://downloads.sourceforge.net/project/picard/picard-tools/1.77/picard-tools-1.77.zip
unzip picard-tools-1.77.zip
ln -s $LKSRC_DIR/picard-tools-1.77 $LKTOOLS_DIR/picard-tools
