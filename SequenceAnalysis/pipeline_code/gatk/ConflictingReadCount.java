...
import org.broadinstitute.gatk.tools.walkers.phasing.ReadBackedPhasing;
...
public class ConflictingReadCount extends InfoFieldAnnotation implements RodRequiringAnnotation {
    ...
    public static final String MAX_CR_KEY = "MAX_CR";
    ...
    public Map<String, Object> annotate(final RefMetaDataTracker tracker,
        ...
        for (String sn : stratifiedContexts.keySet())
        {
            ...
            pcts.add((double) totalMismatchedForSample / (double) totalForSample);
        }

        attributeMap.put(CR_KEY, totalMismatched);
        attributeMap.put(MAX_CR_KEY, String.format("%.4f", Collections.max(pcts)));
    ...
    public List<VCFInfoHeaderLine> getDescriptions() { return Arrays.asList(
            ...
            new VCFInfoHeaderLine(MAX_CR_KEY, 1, VCFHeaderLineType.Float, "Max percent of reads that conflict with the called genotypes for a given sample."));
    }
}
