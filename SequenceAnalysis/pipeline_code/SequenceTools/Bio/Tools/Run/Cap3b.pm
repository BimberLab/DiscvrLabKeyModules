...
Bio::Tools::Run::Cap3b - wrapper for CAP3

=head1 SYNOPSIS

  use Bio::Tools::Run::Cap3b;
  # Run Cap3 using an input FASTA file
  my $factory = Bio::Tools::Run::Cap3b->new( -clipping_range => 150 );
...
=head2 new
 ...
 Returns : A Bio::Tools::Run::Cap3b object
...
sub _run {
  ...
  move ($output_file, $ace_file) or $self->throw("Could not move file '$ace_file' to '$output_file': $!");

#  $self->{'_result'} = $ace_file;
  return $ace_file;
}
