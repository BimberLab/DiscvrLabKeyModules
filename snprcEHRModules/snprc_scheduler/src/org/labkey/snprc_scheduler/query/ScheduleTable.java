...
public class ScheduleTable extends SimpleUserSchema.SimpleTable<SNPRC_schedulerUserSchema>
{
    ...
    public ScheduleTable(SNPRC_schedulerUserSchema schema, TableInfo table)
    {
        super(schema, table);
    }
