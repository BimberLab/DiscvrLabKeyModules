...
public class JBrowseSequenceFileHandler implements SequenceFileHandler
{
    ...
    {
        return new SimpleButtonConfigFactory(ModuleLoader.getInstance().getModule(JBrowseModule.class), "View In JBrowse", "JBrowse.window.DatabaseWindow.outputFilesHandler(dataRegionName);", new LinkedHashSet<>(Arrays.asList(ClientDependency.fromPath("jbrowse/window/DatabaseWindow.js"))));
    }
