...
export default jbrowse => {
    ...
    function FilterForm(props){
        ...
        const existingFilters = (readConfObject(trackConfig, ['adapter', 'filters']) || '').split(';')
        ...
        const handleSubmit = (event) => {
            ...
            if (!trackConfig.adapter.filters) {
            ...
            trackConfig.adapter.filters.set(activeFilters.join(';'))
