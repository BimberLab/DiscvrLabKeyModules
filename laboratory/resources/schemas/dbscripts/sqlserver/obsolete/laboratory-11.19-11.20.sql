...
EXEC core.fn_dropifexists 'employees', 'laboratory', 'TABLE', NULL
GO
...
EXEC core.fn_dropifexists 'reports', 'laboratory', 'TABLE', NULL
GO
...
(
  ...
  reporttitle character varying(255),
  visible bit,
  containerpath character varying(255),
...
EXEC core.fn_dropifexists 'report_types', 'laboratory', 'TABLE', NULL
GO
...
-- ----------------------------
EXEC core.fn_dropifexists 'subjects', 'laboratory', 'TABLE', NULL
GO
...
-- ----------------------------
EXEC core.fn_dropifexists 'species', 'laboratory', 'TABLE', NULL
GO
...
EXEC core.fn_dropifexists 'geographic_origins', 'laboratory', 'TABLE', NULL
GO
...
EXEC core.fn_dropifexists 'well_layout', 'laboratory', 'TABLE', NULL
GO
...
-- ----------------------------
EXEC core.fn_dropifexists 'genders', 'laboratory', 'TABLE', NULL
GO
...
EXEC core.fn_dropifexists 'samples', 'laboratory', 'TABLE', NULL
GO
...
alter table laboratory.reports
  add subjectFieldName varchar(100)
  go

/* laboratory-11.17-11.18.sql */

alter table laboratory.inventory
  add parentSample int
  go

/* laboratory-11.18-11.19.sql */

EXEC core.fn_dropifexists 'datatypes', 'laboratory', 'TABLE', NULL
GO
...
--rename inventory
EXEC sp_rename 'laboratory.inventory', 'samples'
go

alter table laboratory.samples
  add labwareIdentifier varchar(200)
  go
...
alter table laboratory.samples
  add cane2 varchar(100)
alter table laboratory.samples
  add box2 varchar(100)
alter table laboratory.samples
  add box_row2 varchar(100)
alter table laboratory.samples
  add box_column2 varchar(100)
go
...
EXEC sp_rename 'laboratory.samples.cane2', 'cane', 'COLUMN'
EXEC sp_rename 'laboratory.samples.box2', 'box', 'COLUMN'
EXEC sp_rename 'laboratory.samples.box_row2', 'box_row', 'COLUMN'
EXEC sp_rename 'laboratory.samples.box_column2', 'box_column', 'COLUMN'
GO
;